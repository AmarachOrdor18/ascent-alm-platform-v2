  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // ───── Ecobank brand ramp, registered in the theme ─────
        // v1 declared these as hand-written classes in @layer utilities, so
        // opacity modifiers (e.g. bg-danger/20) silently did nothing. Same
        // CSS variables, now with the full Tailwind colour API.
        navy: {
