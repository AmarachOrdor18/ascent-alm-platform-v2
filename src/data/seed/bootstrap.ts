...
async function writeSeed(repo: Repository): Promise<void> {
  ...
  // Only Nigeria has committed data. Ghana is mid-onboarding awaiting its
  // first load, and Côte d'Ivoire has not started — the three lifecycle
  // states the demo walks through.
